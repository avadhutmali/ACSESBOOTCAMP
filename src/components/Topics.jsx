...
const Topics = () => {
  return (
    <div className="mx-auto max-w-7xl h-[70vh] flex flex-col lg:flex-row items-center justify-between px-4">
      <div className="w-full lg:w-1/3 p-8 text-white">
        ...
        >
          Register
          <svg
            className="w-6 sm:w-8 h-6 sm:h-8 justify-end group-hover:rotate-90 group-hover:bg-gray-50 text-gray-50 ease-linear duration-300 rounded-full border border-gray-700 group-hover:border-none p-1 sm:p-2 rotate-45"
            viewBox="0 0 16 19"
